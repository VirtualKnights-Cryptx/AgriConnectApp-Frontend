...
const FieldDetailsScreen: React.FC<FieldDetailsScreenProps> = ({ route, navigation }) => {
  ...
  const fetchSuggestions = async () => {
    ...
    try {
      ...
      const savedSuggestionsUrl = `https://agri-connect-backend2.vercel.app/api/suggestions/${field.id}/saved`;
      ...
      try {
        ...
        if (response.status === 404) {
          ...
          const newSuggestionsUrl = `https://agri-connect-backend2.vercel.app/api/suggestions/${field.id}`;
