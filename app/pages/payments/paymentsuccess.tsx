    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={styles.message}>
          Thank you for your payment. Your product has been successfully purchased.
        ...
        <View style={styles.detailsContainer}>
          ...
          <View style={styles.detailItem}>
            ...
            <Text style={styles.detailText}>Check your email for purchase confirmation</Text>
          </View>
          <View style={styles.detailItem}>
            <Icon name="cube-outline" size={24} color="#666" />
            <Text style={styles.detailText}>Track your product delivery status in the app</Text>
          </View>
          <View style={styles.detailItem}>
